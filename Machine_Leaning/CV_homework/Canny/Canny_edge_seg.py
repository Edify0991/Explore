# 参考https://blog.csdn.net/qq_38828370/article/details/119696756及https://blog.csdn.net/IYXUAN/article/details/124574726
import numpy as np
import cv2 as cv
...
if __name__ == "__main__":
    # code to read image
    image = cv.imread('scenary.jpeg', 0)
    ...
    cv.imwrite('canny_out.jpg', output_image)
    cv.waitKey(0)
