# 参考https://blog.csdn.net/Ibelievesunshine/article/details/105016890
...
# Read image
img = cv2.imread("scenary.jpeg").astype(np.float32)
...
opening_result = Morphology_Opening(otsu, time=1)
closing_result = Morphology_Closing(otsu, time=1)
...
cv2.imwrite("opening_result.jpg", opening_result)
cv2.imwrite("closing_result.jpg", closing_result)
cv2.waitKey(0)
